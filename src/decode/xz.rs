...
use crate::xz::{
    crc::{CRC32, CRC64},
    footer, header, CheckMethod, StreamFlags,
};
    ...
    W: io::Write,
{
    ...
    {
        let mut digested = util::DigestRead::new(input, &mut digest);
    ...
    R: io::BufRead,
{
    ...
    {
        let mut digested = util::DigestRead::new(count_input, &mut digest);
    ...
    W: io::Write,
{
    ...
    let block_header = {
        ...
        let mut digested = io::BufReader::new(util::DigestRead::new(&mut taken, &mut digest));
